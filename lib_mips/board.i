...
const char version_string[] =
        "U-Boot 1.1.4"" (Build from LSDK-" "20250523_14h25m45s_khaid" " at " "May 23 2025" " - " "14:25:52" ")";
...
{
 ulong dest_addr = 0x80010000 + gd->reloc_off;
...
static int init_baudrate (void)
{
 ...
 gd->baudrate = (i > 0)
   ? (int) simple_strtoul (tmp, ((void *)0), 10)
   : 115200;
...
void board_init_f(ulong bootflag)
{
 ...
 ulong addr, addr_sp, len = (ulong)&uboot_end - 0x80010000;
 ulong *s;
...
void board_init_r (gd_t *id, ulong dest_addr)
{
 ...
 gd->reloc_off = dest_addr - 0x80010000;
 ...
 if ((s = getenv ("loadaddr")) != ((void *)0)) {
  load_addr = simple_strtoul (s, ((void *)0), 16);
 }

 if ((s = getenv ("bootfile")) != ((void *)0)) {
