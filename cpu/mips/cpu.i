...
# 26 "cpu.c" 2
# 1 "/workspace/u-boot/include/asm/inca-ip.h" 1
# 27 "cpu.c" 2
# 45 "cpu.c"
int do_reset(cmd_tbl_t *cmdtp, int flag, int argc, char *argv[])
{
 ...
 while (1) {
  do { ((*(volatile ath_reg_t *)((__typeof__(0x1806001c))(((unsigned long)(0x1806001c) & 0x1fffffff) | 0xa0000000))) = ((((1) << 24) & 0x01000000))); (*(volatile ath_reg_t *)((__typeof__(0x1806001c))(((unsigned long)(0x1806001c) & 0x1fffffff) | 0xa0000000))); } while(0);
 }
# 91 "cpu.c"
 return 0;
}
...
void write_one_tlb( int index, u32 pagemask, u32 hi, u32 low0, u32 low1 ){
 __asm__ __volatile__( "mtc0\t%0,""$2""\n\t" "nop" : : "r" (low0));;
 __asm__ __volatile__( "mtc0\t%0,""$5""\n\t" "nop" : : "r" (pagemask));;
 __asm__ __volatile__( "mtc0\t%0,""$3""\n\t" "nop" : : "r" (low1));;
 __asm__ __volatile__( "mtc0\t%0,""$10""\n\t" "nop" : : "r" (hi));;
