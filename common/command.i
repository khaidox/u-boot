...
int do_help (cmd_tbl_t * cmdtp, int flag, int argc, char *argv[])
{
 ...
 for (i = 1; i < argc; ++i) {
  if ((cmdtp = find_cmd (argv[i])) != ((void *)0)) {
...
cmd_tbl_t __u_boot_cmd_help __attribute__ ((unused,section (".u_boot_cmd"))) = {"help", 16, 1, do_help, "help    - print online help\n", "[command ...]\n" "    - show help information (for 'command')\n" "'help' prints online help for the monitor commands.\n\n" "Without arguments, it prints a short usage message for all commands.\n\n" "To get detailed help information for specific commands you can type\n" "'help' with one or more command names as arguments.\n"}
# 329 "command.c"
 ;



cmd_tbl_t __u_boot_cmd_question_mark __attribute__ ((unused,section (".u_boot_cmd"))) = {
 "?", 16, 1, do_help,
  "?       - alias for 'help'\n",
 ((void *)0)
};
...
cmd_tbl_t *find_cmd (const char *cmd)
{
 ...
 len = ((p = strchr(cmd, '.')) == ((void *)0)) ? strlen (cmd) : (p - cmd);
