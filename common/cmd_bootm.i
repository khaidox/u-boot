...
# 32 "cmd_bootm.c" 2
# 1 "/workspace/u-boot/include/zlib.h" 1
# 118 "/workspace/u-boot/include/zlib.h"
...
# 252 "/workspace/u-boot/include/zlib.h"
...
# 274 "/workspace/u-boot/include/zlib.h"
extern int inflate (z_stream *strm, int flush);
# 325 "/workspace/u-boot/include/zlib.h"
extern int inflateEnd (z_stream *strm);
# 338 "/workspace/u-boot/include/zlib.h"
extern int inflateInit2 (z_stream *strm, int windowBits)
                        ;
# 371 "/workspace/u-boot/include/zlib.h"
extern int inflateSync (z_stream *strm);
# 386 "/workspace/u-boot/include/zlib.h"
extern int inflateReset (z_stream *strm);
# 396 "/workspace/u-boot/include/zlib.h"
extern int inflateIncomp (z_stream *strm);
# 413 "/workspace/u-boot/include/zlib.h"
extern uLong adler32 (uLong adler, Bytef *buf, uInt len);
# 431 "/workspace/u-boot/include/zlib.h"
    struct internal_state {int dummy;};
# 33 "cmd_bootm.c" 2
# 1 "/workspace/u-boot/include/bzlib.h" 1
# 97 "/workspace/u-boot/include/bzlib.h"
typedef
   struct {
      char *next_in;
   ...
   bz_stream;
# 144 "/workspace/u-boot/include/bzlib.h"
...
# 250 "/workspace/u-boot/include/bzlib.h"
...
# 280 "/workspace/u-boot/include/bzlib.h"
extern const char * BZ2_bzlibVersion (
      void
   );
# 34 "cmd_bootm.c" 2
# 1 "/workspace/u-boot/include/LzmaWrapper.h" 1
# 34 "/workspace/u-boot/include/LzmaWrapper.h"
extern int lzma_inflate(unsigned char *source, int s_len, unsigned char *dest, int *d_len);
# 35 "cmd_bootm.c" 2
# 1 "/workspace/u-boot/include/environment.h" 1
# 94 "/workspace/u-boot/include/environment.h"
typedef struct environment_s {
 unsigned long crc;



 unsigned char data[((64*1024) - (sizeof(unsigned long)))];
} env_t;
# 36 "cmd_bootm.c" 2
...
ulong load_addr = 0x81000000;


ushort fw_recovery = 0;
# 499 "cmd_bootm.c"
# 1 "/workspace/u-boot/include/tpLinuxTag.h" 1
# 24 "/workspace/u-boot/include/tpLinuxTag.h"
...
image_header_t *fake_image_header(image_header_t *hdr, ulong kernelTextAddr, ulong entryPoint, int size)
{
 ...
 hdr->ih_magic = ((__u32)(0x27051956));
 hdr->ih_time = 0;
 hdr->ih_size = ((__u32)(size));
 hdr->ih_load = ((__u32)(kernelTextAddr));
 hdr->ih_ep = ((__u32)(entryPoint));
 hdr->ih_dcrc = ((__u32)(checksum));
 hdr->ih_os = 5;
 hdr->ih_arch = 5;
 hdr->ih_type = 2;
 hdr->ih_comp = 1;

 strncpy((char *)hdr->ih_name, "(none)", 32);

 hdr->ih_hcrc = ((__u32)(checksum));
...
int do_bootm (cmd_tbl_t *cmdtp, int flag, int argc, char *argv[])
{
 ...
 if (argc < 2) {
  ...
  addr = simple_strtoul(argv[1], ((void *)0), 16);
 }
...
# 601 "cmd_bootm.c"
 ...
 mips_icache_flush_ix();
  ...
  i = lzma_inflate ((unsigned char *)data, len, (unsigned char*)((__u32)(hdr->ih_load)), &unc_len);
  if (i != 0) {
...
cmd_tbl_t __u_boot_cmd_bootm __attribute__ ((unused,section (".u_boot_cmd"))) = {"bootm", 16, 1, do_bootm, "bootm   - boot application image from memory\n", "[addr [arg ...]]\n    - boot application image stored in memory\n" "\tpassing arguments 'arg ...'; when booting a Linux kernel,\n" "\t'arg' can be the address of an initrd image\n"}
...
# 1072 "cmd_bootm.c"
 ...
 } else if ((cmdline = getenv("bootargs")) == ((void *)0)) {
  cmdline = "";
 }

 loader = (void (*)(bd_t *, image_header_t *, char *, char *)) ((__u32)(hdr->ih_ep));
...
cmd_tbl_t __u_boot_cmd_bootd __attribute__ ((unused,section (".u_boot_cmd"))) = {"bootd", 1, 1, do_bootd, "bootd   - boot default, i.e., run 'bootcmd'\n", ((void *)0)}
...
print_image_hdr (image_header_t *hdr)
{
 ...
 time_t timestamp = (time_t)((__u32)(hdr->ih_time));
 struct rtc_time tm;
 ...
 printf ("\n   Data Size:    %d Bytes = ", ((__u32)(hdr->ih_size)));
 print_size (((__u32)(hdr->ih_size)), "\n");
 printf ("   Load Address: %08x\n"
  "   Entry Point:  %08x\n",
   ((__u32)(hdr->ih_load)), ((__u32)(hdr->ih_ep)));
 ...
 if (hdr->ih_type == 4) {
  ...
  puts ("   Contents:\n");
  for (i=0; (len = ((__u32)(*len_ptr))); ++i, ++len_ptr) {
...
print_type (image_header_t *hdr)
{
 ...
 switch (hdr->ih_os) {
 case 0: os = "Invalid OS"; break;
 case 2: os = "NetBSD"; break;
 case 5: os = "Linux"; break;
 case 14: os = "VxWorks"; break;
 case 16: os = "QNX"; break;
 case 17: os = "U-Boot"; break;
 case 18: os = "RTEMS"; break;
 ...
 switch (hdr->ih_arch) {
 case 0: arch = "Invalid CPU"; break;
 case 1: arch = "Alpha"; break;
 case 2: arch = "ARM"; break;
 case 3: arch = "Intel x86"; break;
 case 4: arch = "IA64"; break;
 case 5: arch = "MIPS"; break;
 case 6: arch = "MIPS 64 Bit"; break;
 case 7: arch = "PowerPC"; break;
 case 8: arch = "IBM S390"; break;
 case 9: arch = "SuperH"; break;
 case 10: arch = "SPARC"; break;
 case 11: arch = "SPARC 64 Bit"; break;
 case 12: arch = "M68K"; break;
 case 14: arch = "Microblaze"; break;
 case 13: arch = "Nios"; break;
 case 15: arch = "Nios-II"; break;
 default: arch = "Unknown Architecture"; break;
 }

 switch (hdr->ih_type) {
 case 0: type = "Invalid Image"; break;
 case 1:type = "Standalone Program"; break;
 case 2: type = "Kernel Image"; break;
 case 3: type = "RAMDisk Image"; break;
 case 4: type = "Multi-File Image"; break;
 case 5: type = "Firmware"; break;
 case 6: type = "Script"; break;
 default: type = "Unknown Image"; break;
 }

 switch (hdr->ih_comp) {
 case 0: comp = "uncompressed"; break;
 case 1: comp = "gzip compressed"; break;
 case 2: comp = "bzip2 compressed"; break;
 case 3: comp = "lzma compressed"; break;
  ...
  ulong addr, ulong *len_ptr, int verify)
{
 ...
 entry_point = (void (*)(bd_t *)) ((__u32)(hdr->ih_ep));
