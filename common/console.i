...
# 27 "console.c" 2
# 1 "/workspace/u-boot/include/console.h" 1
# 27 "/workspace/u-boot/include/console.h"
...
# 28 "/workspace/u-boot/include/console.h" 2
...
# 28 "console.c" 2
# 1 "/workspace/u-boot/include/exports.h" 1
# 9 "/workspace/u-boot/include/exports.h"
...
# 1 "/workspace/u-boot/include/_exports.h" 1
XF_get_version ,
XF_getc ,
XF_tstc ,
XF_putc ,
...
XF_vprintf ,
XF_do_reset ,
# 35 "/workspace/u-boot/include/exports.h" 2
...
void serial_printf (const char *fmt, ...)
{
 va_list args;
 uint i;
 char printbuffer[(512 +sizeof("hb> ")+16)];
...
int console_init_r (void)
{
 device_t *inputdev = ((void *)0), *outputdev = ((void *)0);
 int i, items = ListNumItems (devlist);
# 507 "console.c"
 for (i = 1;
      (i <= items) && ((inputdev == ((void *)0)) || (outputdev == ((void *)0)));
      i++
     ) {
  device_t *dev = ListGetPtrToItem (devlist, i);

  if ((dev->flags & 0x00000001) && (inputdev == ((void *)0))) {
   inputdev = dev;
  }
  if ((dev->flags & 0x00000002) && (outputdev == ((void *)0))) {
   outputdev = dev;
  }
 }
 ...
 puts ("In:    ");
 if (stdio_devices[0] == ((void *)0)) {
  puts ("No input devices available!\n");
 } else {
  printf ("%s\n", stdio_devices[0]->name);
 }

 puts ("Out:   ");
 if (stdio_devices[1] == ((void *)0)) {
  puts ("No output devices available!\n");
 } else {
  printf ("%s\n", stdio_devices[1]->name);
 }

 puts ("Err:   ");
 if (stdio_devices[2] == ((void *)0)) {
  puts ("No error devices available!\n");
 } else {
  printf ("%s\n", stdio_devices[2]->name);
 }
