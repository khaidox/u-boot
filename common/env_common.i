...
uchar default_environment[] = {
 ...
 "bootargs=" "console=ttyS0,115200 root=" "31:02" " rootfstype=squashfs init=/sbin/init " "mtdparts=ath-nor0:128k(u-boot),1024k(kernel),2816k(rootfs),64k(config),64k(art)" "\0"


 "bootcmd=" "bootm 0x9f020000" "\0"
# 82 "env_common.c"
 "bootdelay=" "1" "\0"
 ...
 "ethaddr=" "0xba:0xbe:0xfa:0xce:0x08:0x41" "\0"
# 103 "env_common.c"
...
# 139 "env_common.c"
 "dir=\0" "lu" "=tftp 0x80060000 ${dir}" "u-boot.bin" "&&" "erase" " " "0x9f000000" " " "+$filesize" "&&" "cp.b" " $fileaddr " "0x9f000000" " $filesize\0" "lf" "=tftp 0x80060000 ${dir}" "ap143${bc}-squashfs" "&&" "erase" " " "0x9f120000" " " "+$filesize" "&&" "cp.b" " $fileaddr " "0x9f120000" " $filesize\0" "lk" "=tftp 0x80060000 ${dir}" "vmlinux${bc}.lzma.uImage" "&&" "erase" " " "0x9f020000" " " "+$filesize" "&&" "cp.b" " $fileaddr " "0x9f020000" " $filesize\0" ""
...
{
 env_ptr->crc = crc32(0, env_ptr->data, ((64*1024) - (sizeof(unsigned long))));
}
...
# 221 "env_common.c"
 ...
 if (gd->env_valid == 0) {
  ...
  if (sizeof(default_environment) > ((64*1024) - (sizeof(unsigned long))))
  {
