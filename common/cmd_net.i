...
netboot_common (proto_t proto, cmd_tbl_t *cmdtp, int argc, char *argv[])
{
 ...
 case 2:
  ...
  if (argv[1][0] == '"') {
   ...
   load_addr = simple_strtoul(argv[1], ((void *)0), 16);
  }
  break;

 case 3: load_addr = simple_strtoul(argv[1], ((void *)0), 16);
 ...
 if (((s = getenv("autostart")) != ((void *)0)) && (strcmp(s,"yes") == 0)) {
  char *local_args[2];
  local_args[0] = argv[0];
  local_args[1] = ((void *)0);
...
cmd_tbl_t __u_boot_cmd_ping __attribute__ ((unused,section (".u_boot_cmd"))) = {"ping", 2, 1, do_ping, "ping\t- send ICMP ECHO_REQUEST to network host\n", "pingAddress\n"}
