...
int do_mac (cmd_tbl_t * cmdtp, int flag, int argc, char *argv[])
{
 ...
 memcpy(sectorBuff,(void *)0x9fff0000, (64*1024));
 ...
 flash_erase(flash_info,(64 - 1),(64 - 1));
 write_buff(flash_info,sectorBuff, 0x9fff0000, (64*1024));

 return 0;
}


cmd_tbl_t __u_boot_cmd_progmac __attribute__ ((unused,section (".u_boot_cmd"))) = {"progmac", 3, 0, do_mac, "progmac - Set ethernet MAC addresses\n", "progmac <serno> [<product_id>] - Program the MAC addresses\n" "                <serno> is the value of the last\n" "                4 digits (decimal) of the serial number.\n" "                Optional parameter <product_id> specifies\n" "                the board's product ID (decimal)\n"}
