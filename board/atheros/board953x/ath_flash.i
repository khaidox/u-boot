...
# 2 "../common/ath_flash.c" 2
# 1 "/workspace/u-boot/include/jffs2/jffs2.h" 1
# 42 "/workspace/u-boot/include/jffs2/jffs2.h"
# 1 "/workspace/u-boot/include/jffs2/load_kernel.h" 1
# 28 "/workspace/u-boot/include/jffs2/load_kernel.h"
# 1 "/workspace/u-boot/include/linux/list.h" 1
...
# 19 "/workspace/u-boot/include/linux/list.h"
struct list_head {
 struct list_head *next, *prev;
};
# 38 "/workspace/u-boot/include/linux/list.h"
...
# 56 "/workspace/u-boot/include/linux/list.h"
static inline void list_add(struct list_head *new, struct list_head *head)
{
 __list_add(new, head, head->next);
}
# 69 "/workspace/u-boot/include/linux/list.h"
static inline void list_add_tail(struct list_head *new, struct list_head *head)
{
 __list_add(new, head->prev, head);
}
# 81 "/workspace/u-boot/include/linux/list.h"
...
# 173 "/workspace/u-boot/include/linux/list.h"
...
# 29 "/workspace/u-boot/include/jffs2/load_kernel.h" 2
...
# 43 "/workspace/u-boot/include/jffs2/jffs2.h" 2
# 110 "/workspace/u-boot/include/jffs2/jffs2.h"
...
ath_spi_read_id(void)
{
 ...
 ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x70000));
 do { int i; for(i = 0; i < 8; i++) { ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60000 | (((0x9f) & (1 << (7 - i))) >> (7 - i)))); ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60100 | (((0x9f) & (1 << (7 - i))) >> (7 - i)))); } } while (0);
 do { int i; for(i = 0; i < 8; i++) { ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60000 | (((0) & (1 << (7 - i))) >> (7 - i)))); ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60100 | (((0) & (1 << (7 - i))) >> (7 - i)))); } } while (0);
 do { int i; for(i = 0; i < 8; i++) { ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60000 | (((0) & (1 << (7 - i))) >> (7 - i)))); ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60100 | (((0) & (1 << (7 - i))) >> (7 - i)))); } } while (0);
 do { int i; for(i = 0; i < 8; i++) { ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60000 | (((0) & (1 << (7 - i))) >> (7 - i)))); ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60100 | (((0) & (1 << (7 - i))) >> (7 - i)))); } } while (0);
 do { ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60000)); ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x70000)); } while (0);

 rd = (*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x0c)))(((unsigned long)((0x1f000000 +0x0c)) & 0x1fffffff) | 0xa0000000)));

 printf("Flash Manuf Id 0x%x, DeviceId0 0x%x, DeviceId1 0x%x\n",
  (rd >> 16) & 0xff, (rd >> 8) & 0xff, (rd >> 0) & 0xff);
}
# 57 "../common/ath_flash.c"
unsigned long flash_init(void)
{
# 68 "../common/ath_flash.c"
 do { do { ((*(volatile ath_reg_t *)((__typeof__(((0x1f000000 +0x00))))(((unsigned long)(((0x1f000000 +0x00))) & 0x1fffffff) | 0xa0000000))) = (((*(volatile ath_reg_t *)((__typeof__(((0x1f000000 +0x00))))(((unsigned long)(((0x1f000000 +0x00))) & 0x1fffffff) | 0xa0000000))) | (1)))); (*(volatile ath_reg_t *)((__typeof__(((0x1f000000 +0x00))))(((unsigned long)(((0x1f000000 +0x00))) & 0x1fffffff) | 0xa0000000))); } while(0); (*(volatile ath_reg_t *)((__typeof__(((0x1f000000 +0x00))))(((unsigned long)(((0x1f000000 +0x00))) & 0x1fffffff) | 0xa0000000))); } while(0);
 ath_spi_read_id();
 do { do { ((*(volatile ath_reg_t *)((__typeof__(((0x1f000000 +0x00))))(((unsigned long)(((0x1f000000 +0x00))) & 0x1fffffff) | 0xa0000000))) = (((*(volatile ath_reg_t *)((__typeof__(((0x1f000000 +0x00))))(((unsigned long)(((0x1f000000 +0x00))) & 0x1fffffff) | 0xa0000000))) & ~(1)))); (*(volatile ath_reg_t *)((__typeof__(((0x1f000000 +0x00))))(((unsigned long)(((0x1f000000 +0x00))) & 0x1fffffff) | 0xa0000000))); } while(0); (*(volatile ath_reg_t *)((__typeof__(((0x1f000000 +0x00))))(((unsigned long)(((0x1f000000 +0x00))) & 0x1fffffff) | 0xa0000000))); } while(0);
...
ath_spi_write_enable()
{
 ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x00)))(((unsigned long)((0x1f000000 +0x00)) & 0x1fffffff) | 0xa0000000))) = (1));
 ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x70000));
 do { int i; for(i = 0; i < 8; i++) { ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60000 | (((0x06) & (1 << (7 - i))) >> (7 - i)))); ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60100 | (((0x06) & (1 << (7 - i))) >> (7 - i)))); } } while (0);
 do { ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60000)); ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x70000)); } while (0);
}
...
ath_spi_poll()
{
 ...
 do {
  ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x70000));
  do { int i; for(i = 0; i < 8; i++) { ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60000 | (((0x05) & (1 << (7 - i))) >> (7 - i)))); ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60100 | (((0x05) & (1 << (7 - i))) >> (7 - i)))); } } while (0);
  do { int i; for(i = 0; i < 8; i++) { ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60000 | (((0) & (1 << (7 - i))) >> (7 - i)))); ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60100 | (((0) & (1 << (7 - i))) >> (7 - i)))); } } while (0);
  rd = ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x0c)))(((unsigned long)((0x1f000000 +0x0c)) & 0x1fffffff) | 0xa0000000))) & 1);
 } while (rd);
}
...
ath_spi_write_page(uint32_t addr, uint8_t *data, int len)
{
 ...
 ;
 ath_spi_write_enable();
 do { int i; for(i = 0; i < 8; i++) { ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60000 | (((0x02) & (1 << (7 - i))) >> (7 - i)))); ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60100 | (((0x02) & (1 << (7 - i))) >> (7 - i)))); } } while (0);
 do { do { int i; for(i = 0; i < 8; i++) { ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60000 | (((((addr & 0xff0000) >> 16)) & (1 << (7 - i))) >> (7 - i)))); ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60100 | (((((addr & 0xff0000) >> 16)) & (1 << (7 - i))) >> (7 - i)))); } } while (0); do { int i; for(i = 0; i < 8; i++) { ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60000 | (((((addr & 0x00ff00) >> 8)) & (1 << (7 - i))) >> (7 - i)))); ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60100 | (((((addr & 0x00ff00) >> 8)) & (1 << (7 - i))) >> (7 - i)))); } } while (0); do { int i; for(i = 0; i < 8; i++) { ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60000 | (((addr & 0x0000ff) & (1 << (7 - i))) >> (7 - i)))); ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60100 | (((addr & 0x0000ff) & (1 << (7 - i))) >> (7 - i)))); } } while (0); } while (0);

 for (i = 0; i < len; i++) {
  ch = *(data + i);
  do { int i; for(i = 0; i < 8; i++) { ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60000 | (((ch) & (1 << (7 - i))) >> (7 - i)))); ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60100 | (((ch) & (1 << (7 - i))) >> (7 - i)))); } } while (0);
 }
...
{
 ath_spi_write_enable();
 do { int i; for(i = 0; i < 8; i++) { ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60000 | (((0xd8) & (1 << (7 - i))) >> (7 - i)))); ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60100 | (((0xd8) & (1 << (7 - i))) >> (7 - i)))); } } while (0);
 do { do { int i; for(i = 0; i < 8; i++) { ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60000 | (((((addr & 0xff0000) >> 16)) & (1 << (7 - i))) >> (7 - i)))); ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60100 | (((((addr & 0xff0000) >> 16)) & (1 << (7 - i))) >> (7 - i)))); } } while (0); do { int i; for(i = 0; i < 8; i++) { ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60000 | (((((addr & 0x00ff00) >> 8)) & (1 << (7 - i))) >> (7 - i)))); ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60100 | (((((addr & 0x00ff00) >> 8)) & (1 << (7 - i))) >> (7 - i)))); } } while (0); do { int i; for(i = 0; i < 8; i++) { ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60000 | (((addr & 0x0000ff) & (1 << (7 - i))) >> (7 - i)))); ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60100 | (((addr & 0x0000ff) & (1 << (7 - i))) >> (7 - i)))); } } while (0); } while (0);
 do { ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x60000)); ((*(volatile ath_reg_t *)((__typeof__((0x1f000000 +0x08)))(((unsigned long)((0x1f000000 +0x08)) & 0x1fffffff) | 0xa0000000))) = (0x70000)); } while (0);
 ;
 ath_spi_poll();
}
# 255 "../common/ath_flash.c"
static void ath_gpio_set_val(int reg, int gpio, int val)
{
 if (val & 0x1) {
  do { do { ((*(volatile ath_reg_t *)((__typeof__((reg)))(((unsigned long)((reg)) & 0x1fffffff) | 0xa0000000))) = (((*(volatile ath_reg_t *)((__typeof__((reg)))(((unsigned long)((reg)) & 0x1fffffff) | 0xa0000000))) | ((1 << gpio))))); (*(volatile ath_reg_t *)((__typeof__((reg)))(((unsigned long)((reg)) & 0x1fffffff) | 0xa0000000))); } while(0); (*(volatile ath_reg_t *)((__typeof__((reg)))(((unsigned long)((reg)) & 0x1fffffff) | 0xa0000000))); } while(0);
 } else {
  do { do { ((*(volatile ath_reg_t *)((__typeof__((reg)))(((unsigned long)((reg)) & 0x1fffffff) | 0xa0000000))) = (((*(volatile ath_reg_t *)((__typeof__((reg)))(((unsigned long)((reg)) & 0x1fffffff) | 0xa0000000))) & ~((1 << gpio))))); (*(volatile ath_reg_t *)((__typeof__((reg)))(((unsigned long)((reg)) & 0x1fffffff) | 0xa0000000))); } while(0); (*(volatile ath_reg_t *)((__typeof__((reg)))(((unsigned long)((reg)) & 0x1fffffff) | 0xa0000000))); } while(0);
 }
}
...
void ath_auf_gpio_init()
{
 ...
 ath_gpio_set_val(0x18040000, (12), 1);


 ath_gpio_set_val(0x18040000, (3), 0);
}
# 283 "../common/ath_flash.c"
int ath_is_rst_btn_pressed()
{
 ...
 udelay(10 * 1000);
 old_val = (*(volatile ath_reg_t *)((__typeof__(0x18040004))(((unsigned long)(0x18040004) & 0x1fffffff) | 0xa0000000)));
 udelay(1000);
 val = (*(volatile ath_reg_t *)((__typeof__(0x18040004))(((unsigned long)(0x18040004) & 0x1fffffff) | 0xa0000000)));
...
# 313 "../common/ath_flash.c"
void ath_fw_led_on()
{
 ath_gpio_set_val(0x18040008, (3), (0));
}
