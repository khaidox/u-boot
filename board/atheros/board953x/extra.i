# 1 "/workspace/u-boot/board/atheros/board953x/extra.c"
...
# 2 "/workspace/u-boot/board/atheros/board953x/extra.c" 2
...
# 3 "/workspace/u-boot/board/atheros/board953x/extra.c" 2


# 1 "/workspace/u-boot/include/config.h" 1
# 6 "/workspace/u-boot/board/atheros/board953x/extra.c" 2
...
# 7 "/workspace/u-boot/board/atheros/board953x/extra.c" 2
...
void ath_set_tuning_caps(void)
{
 ...
 uint32_t val;
        ...
        eep = (ar9300_eeprom_t *)0x9fff1000;

 val = (((0x0) << 31) & 0x80000000) |
  (((0x4b) << 24) & 0x7f000000) |
  (((0x4b) << 17) & 0x00fe0000) |
  (((0x3) << 15) & 0x00018000) |
  (((0x0) << 14) & 0x00004000) |
 ...
 if ((eep->featureEnable & 0x40) && (eep->pad[0x0] != 0xff)) {
  val &= ~(0x7f000000 | 0x00fe0000);
  val |= (((eep->params_for_tuning_caps[0]) << 24) & 0x7f000000) |
   (((eep->params_for_tuning_caps[0]) << 17) & 0x00fe0000);
 }

 do { ((*(volatile ath_reg_t *)((__typeof__(0x181162c0))(((unsigned long)(0x181162c0) & 0x1fffffff) | 0xa0000000))) = (val)); (*(volatile ath_reg_t *)((__typeof__(0x181162c0))(((unsigned long)(0x181162c0) & 0x1fffffff) | 0xa0000000))); } while(0);
 do { ((*(volatile ath_reg_t *)((__typeof__(0x181162c4))(((unsigned long)(0x181162c4) & 0x1fffffff) | 0xa0000000))) = ((((0x1) << 10) & 0x00000400) | (((0x1) << 7) & 0x00000080))); (*(volatile ath_reg_t *)((__typeof__(0x181162c4))(((unsigned long)(0x181162c4) & 0x1fffffff) | 0xa0000000))); } while(0)
                                ;
 do { ((*(volatile ath_reg_t *)((__typeof__(0x181162c8))(((unsigned long)(0x181162c8) & 0x1fffffff) | 0xa0000000))) = ((((0x400) << 16) & 0x07ff0000) | (((0x51) << 2) & 0x00007ffc))); (*(volatile ath_reg_t *)((__typeof__(0x181162c8))(((unsigned long)(0x181162c8) & 0x1fffffff) | 0xa0000000))); } while(0)
                                     ;




 printf("Setting " "0x181162c0" " to 0x%x\n", val);
 return;
}
