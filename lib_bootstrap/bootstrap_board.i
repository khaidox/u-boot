...
# 27 "bootstrap_board.c" 2
# 1 "/workspace/u-boot/include/devices.h" 1
# 24 "/workspace/u-boot/include/devices.h"
# 1 "/workspace/u-boot/include/lists.h" 1
...
# 25 "/workspace/u-boot/include/devices.h" 2
# 39 "/workspace/u-boot/include/devices.h"
typedef struct {
 int flags;
 int ext;
 char name[16];
...
# 72 "/workspace/u-boot/include/devices.h"
typedef struct {
 void *address;
 ushort width;
 ushort height;
...
# 36 "bootstrap_board.c" 2



register volatile gd_t *gd asm ("k0");
# 59 "bootstrap_board.c"
...
const char version_string[] =
 "U-Boot 1.1.4"" (" "May 23 2025" " - " "14:25:52" ")";
...
static void mem_malloc_init (ulong dest_addr)
{
 ...
 mem_malloc_start = dest_addr - ((128*1024) + (64*1024));
...
{
# 174 "bootstrap_board.c"
 gd->baudrate = 115200;

 return (0);
}
# 226 "bootstrap_board.c"
...
void bootstrap_board_init_f(ulong bootflag)
{
 ...
 ulong addr, addr_sp, len = (ulong)&uboot_end_bootstrap - 0x9f000000;
 ulong *s;
...
void bootstrap_board_init_r (gd_t *id, ulong dest_addr)
{
 ...
 printf("\n Compressed Image at %08x \n ", (0x9f000000 + ((ulong)&uboot_end_data_bootstrap - dest_addr)));


 addr = (char *)(0x9f000000 + ((ulong)&uboot_end_data_bootstrap - dest_addr));
 memmove (&header, (char *)addr, sizeof(image_header_t));

 if (((__u32)(hdr->ih_magic)) != 0x27051956) {
 ...
 i = lzma_inflate ((unsigned char *)data, len, (unsigned char*)((__u32)(hdr->ih_load)), &destLen);
 if (i != 0) {
