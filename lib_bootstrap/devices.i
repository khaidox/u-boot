...
list_t devlist = 0;
device_t *stdio_devices[] = { ((void *)0), ((void *)0), ((void *)0) };
...
static void drv_system_init (void)
{
 ...
 dev.flags = 0x00000002 | 0x00000001 | 0x80000000;
...
int devices_init (void)
{
 ...
 if (devlist == ((void *)0)) {
  fputs(2, "Cannot initialize the list of devices!\n");
  return -1;
 }
# 197 "devices.c"
 drv_system_init ();
