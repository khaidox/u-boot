...
# 12 "inca-swap-bytes.c"
int main (void)
{
 short ibuff[64], obuff[64];
 int rc, i, len;
 ...
 while ((rc = read (0, ibuff, sizeof (ibuff))) > 0) {
  ...
  if (write (1, obuff, len) != len) {
   perror ("read error");
   return (
# 27 "inca-swap-bytes.c" 3 4
          1
# 27 "inca-swap-bytes.c"
                      );
  }
 ...
 if (rc < 0) {
  perror ("read error");
  return (
# 35 "inca-swap-bytes.c" 3 4
         1
# 35 "inca-swap-bytes.c"
                     );
 }
 return (
# 37 "inca-swap-bytes.c" 3 4
        0
# 37 "inca-swap-bytes.c"
                    );
}
