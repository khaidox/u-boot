...
enum
  {
    SCM_RIGHTS = 0x01
# 375 "/usr/include/x86_64-linux-gnu/bits/socket.h" 3 4
  };
# 389 "/usr/include/x86_64-linux-gnu/bits/socket.h" 3 4
...
{
  size_t sz = __builtin_dynamic_object_size (__buf, 0);
  if (((__builtin_constant_p (sz) && (sz) == (long unsigned int) -1) || (((__typeof (__n)) 0 < (__typeof (__n)) -1 || (__builtin_constant_p (__n) && (__n) > 0)) && __builtin_constant_p ((((long unsigned int) (__n)) <= ((sz)) / ((sizeof (char))))) && (((long unsigned int) (__n)) <= ((sz)) / ((sizeof (char)))))))
...
# 344 "/usr/include/x86_64-linux-gnu/sys/socket.h" 2 3 4
...
# 35 "mkimage.c" 2
# 61 "mkimage.c"
# 1 "../include/image.h" 1 3 4
# 143 "../include/image.h" 3 4
